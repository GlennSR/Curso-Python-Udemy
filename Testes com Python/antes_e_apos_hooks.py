...
# OBS: Abrir códigos "robo.py" e "robo_testes.py"
...
tearDown() -> é executado ao final de cada método de teste. É útil para excluir ou fechar conexões com bancos de dados.
