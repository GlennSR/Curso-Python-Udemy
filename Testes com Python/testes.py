...
class AtividadesTestes(unittest.TestCase):
    ...
    def test_comer_besteira(self):
        """Testando o retorno com besteira"""
    ...
    def test_dormir_pouco(self):
        ...
        self.assertEqual(dormir(4),
                         'Continuo cansado após dormir por 4 horas. :(')

    def test_dormir_muito(self):
        """Testando o retorno dormindo muito"""
        self.assertEqual(dormir(10),
                         'Ptz! Dormi muito! Estou atrasado pro trabalho!')

    def test_eh_engracada(self):
        #self.assertEqual(eh_engracada('Sérgio Malandro'), False)  # Teste não passa
        self.assertFalse(eh_engracada('Sérgio Malandro'), 'Não é')  # Teste passa, considera None = False
